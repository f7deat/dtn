...
const Header: React.FC = () => {
    return (
        <header className="bg-white flex items-center justify-between md:h-22 h-16">
            <div className="uppercase font-bold md:pl-10 pl-4 py-2 md:pr-20">
            ...
            <div className="h-full flex items-center gap-4 md:pl-20">
                <Link href="/login" className="bg-red-600 hidden md:block text-white px-6 py-3 rounded hover:bg-red-700 transition-colors font-bold uppercase">Đăng nhập<FontAwesomeIcon icon={faExternalLink} className="ml-2 w-4 h-4 inline" /></Link>
